...
- **Highest measured throughput:** leptos (30,496 req/s peak)

**Notes:**
- Dioxus Lighthouse audit produced NaN values; rebuild and re-run Lighthouse in idle conditions (no concurrent stress test).

- Top throughput (top 3): leptos (30,496 req/s), yew (27,598 req/s), vue (27,157 req/s)
- Smallest bundles (top 3): blade (1.32 KB), vue (25.52 KB), react (59.75 KB)
...
| vue | 25.52 KB | 65.94 KB |
| react | 59.75 KB | 191.49 KB |
| angular | 62.78 KB | 192.93 KB |
| yew | 77.48 KB | 275.42 KB |
| leptos | 77.75 KB | 390.72 KB |
...
|-----------|---------------:|----:|----:|----:|------:|
| **Leptos** | 30,496 | N/A | N/A | N/A | 0 |
| **Yew** | 27,598 | N/A | N/A | N/A | 0 |
| **Vue** | 27,157 | N/A | N/A | N/A | 0 |
| **React** | 21,650 | N/A | N/A | N/A | 0 |
| **Angular** | 18,196 | N/A | N/A | N/A | 0 |
...
|-----------|---------------:|----------------:|----:|----:|----:|------:|-------:|
| leptos | 30,496 | 2,000 | N/A | N/A | N/A | 0 | 0 |
| yew | 27,598 | 2,000 | N/A | N/A | N/A | 0 | 0 |
| vue | 27,157 | 2,000 | N/A | N/A | N/A | 0 | 0 |
| react | 21,650 | 2,000 | N/A | N/A | N/A | 0 | 0 |
| angular | 18,196 | 2,000 | N/A | N/A | N/A | 0 | 0 |
